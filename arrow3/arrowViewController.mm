...
{
//    glClearColor(0.65f, 0.f, 0.f, 1.0f);
...
- (BOOL)loadShaders
{
    ...
    vertShaderPathname = [[NSBundle mainBundle] pathForResource:@"sprite" ofType:@"vsh"];
    ...
    fragShaderPathname = [[NSBundle mainBundle] pathForResource:@"sprite" ofType:@"fsh"];
